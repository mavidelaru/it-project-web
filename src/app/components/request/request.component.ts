...
import { RequestService } from '../../services/request/request.service'; // importamos el servicio que contiene las funcionalidades para conectar con la api rest

@Component({
  selector: 'request', // etiqueta del nombre del componente
  templateUrl: './request.component.html', // vista del componente
  styleUrls: ['./request.component.scss'], // hoja de estilo del componente
